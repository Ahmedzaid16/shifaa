...
public class boone_manager extends AppCompatActivity {
    ...
    boone_manager.customListView myAdapter = new boone_manager.customListView(temp);
    DatabaseReference reference;
    Bitmap bitmap;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_boone_manager);
        editTextname = findViewById(R.id.boone_Drugname);
        editTextprice = findViewById(R.id.boone_drugprice);
        imageView = findViewById(R.id.boone_brws_img);
        uplode = findViewById(R.id.boone_add_m);
        lv = findViewById(R.id.boone_list_item_m);
        ...
        uplode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedimg!= null)
                {
                    ...
                    data boone = new data(editTextname.getText().toString(), editTextprice.getText().toString(),key1);
                    reference.child(key1).setValue(boone).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
    ...
    private void uplodeimage() {
        ...
        storageReference= FirebaseStorage.getInstance().getReference("images/boone/"+filename);
